...
describe('keyboard utilities', () => {
  ...
  it('useShouldShowKeyboardShortcuts hook handles keydown and resize', () => {
    ...
    vi.spyOn(KeyboardShortcutState, 'useState').mockReturnValue(mockState as never);
  ...
  it('ignores composing key events and falls back when hook state is empty', () => {
    ...
    vi.spyOn(KeyboardShortcutState, 'useState').mockReturnValue(stateUpdater as never);
    vi.spyOn(window, 'matchMedia').mockReturnValue({ matches: false } as MediaQueryList);
