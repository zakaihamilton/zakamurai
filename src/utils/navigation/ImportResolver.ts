import type { CssImport, FileContents, ImportRange, ImportSource } from './types';
 ...
 */
export function getCssImports(jsCode: string | null | undefined): CssImport[] {
 ...
 */
export function getAssociatedFilePath(
 ...
 */
export function getImportPathCandidates(resolved: string): string[] {
  const withExtension = [
    `${resolved}.js`,
    `${resolved}.jsx`,
    `${resolved}.tsx`,
 ...
 */
export function getImportRanges(code: string | null | undefined, isCss = false): ImportRange[] {
