 ...
 */
export function getLocFromIndex(
 ...
 */
export function findReferencingJsFiles(
  cssFilePath: string | null,
  className: string,
  allFileContents: FileContents | null,
): CssSearchResult[] {
 ...
 */
export function getIdentifierForCssFile(
  jsCode: string,
  jsFilePath: string,
  cssFilePath: string,
): string | null {
 ...
 */
export function findClassReferenceInJs(
  jsCode: string,
  className: string,
  jsFilePath: string | null = null,
  cssFilePath: string | null = null,
): SourceLocation | null {
 ...
 */
export function getExportRanges(code: string | null | undefined): ExportRange[] {
...
export function findComponentDefinition(
  ...
  allFileContents: FileContents,
): { filePath: string; fileName: string; loc: SourceLocation } | null {
