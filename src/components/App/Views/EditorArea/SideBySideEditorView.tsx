...
import type { ScrollContainerRef, SideBySideEditorViewProps } from './types';
...
export default function SideBySideEditorView({
  ...
  handleChange,
  cursorPos,
}: SideBySideEditorViewProps) {
  const leftScrollRef = useRef<HTMLDivElement>(null) as ScrollContainerRef;
  const rightScrollRef = useRef<HTMLDivElement>(null) as ScrollContainerRef;
  ...
  const handleScroll = (source: ScrollContainerRef, target: ScrollContainerRef) => {
