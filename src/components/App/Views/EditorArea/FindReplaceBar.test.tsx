import { createMockFindMatch } from '@/test-utils/editorMocks';
...
describe('FindReplaceBar', () => {
  const baseProps: FindReplaceBarProps = {
    showFind: true,
    setShowFind: vi.fn(),
    findQuery: 'foo',
    setFindQuery: vi.fn(),
    ...
    matches: [createMockFindMatch({ line: 1 }), createMockFindMatch({ line: 2 })],
    matchIndex: 0,
    setMatchIndex: vi.fn(),
    handleFind: vi.fn(),
    handleReplace: vi.fn(),
