...
describe('SingleEditorView', () => {
  ...
  it('syncs gutter heights by visible row order when folded lines keep original numbers', () => {
    ...
    const gutterLine2 = container.querySelector('[data-gutter-line="2"]') as HTMLElement | null;
    const gutterLine10 = container.querySelector('[data-gutter-line="10"]') as HTMLElement | null;
    expect(gutterLine2?.style.height).toBe('22px');
    expect(gutterLine10?.style.height).toBe('44px');
  });
});
