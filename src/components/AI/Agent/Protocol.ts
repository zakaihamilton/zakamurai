...
Do not use blue as the default palette or repeat the same blue across the page, inputs, and buttons. If the user does not specify a theme, choose a warm neutral or editorial direction with charcoal text and one intentional non-blue accent such as terracotta, amber, plum, or green.
